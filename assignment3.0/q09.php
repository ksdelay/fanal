...
// Begin output
print '<article>';
print '<h2>Query 9 SELECT  DISTINCT fldBuilding, count(fldNumStudents), fldDays FROM tblSections WHERE  fldDays like "%W%" GROUP BY fldBuilding order by count(fldNumStudents) desc</h2>';
print '<table>';
